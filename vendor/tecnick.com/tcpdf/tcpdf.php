...
class TCPDF {
	 ...
	 */
	 public function Header() {
        ...
        $this->Image($image_file, 140, 10, 60, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
        // Set font
	 ...
	 */
	 public function Footer() {
		...
		if (empty($this->pagegroups)) {
			$pagenumtxt = $w_page.$this->getAliasNumPage().' de '.$this->getAliasNbPages();
		} else {
			$pagenumtxt = $w_page.$this->getPageNumGroupAlias().' de '.$this->getPageGroupAlias();
		}
        // Custom footer HTML
        $this->html = '<br><span align="center" style="color:#5d5d5d"><strong>Pagare No. Página '.$pagenumtxt.'<br> </span>';
