    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden;">
        ...
        <div style="padding: 24px;padding-top: 10px">
            ...
            <div style="background-color: #0d3a58; padding: 16px; border-radius: 8px; display: flex; align-items: center;">
                <div style="flex-grow: 1;">
                    <p style="margin: 0; font-size: 16px; color: white;">
                        ...
                        <strong style="color: white">APROBADO</strong> con éxito.
                    </p>
                </div>
            </div>
            <div style="margin-top: 24px;">
                ...
                <p style="margin: 0; font-size: 16px;">
                    <span style="color: #0d3a58;"> Fecha de aprobación: </span> <strong> <?php echo $this->fecha_aprobado; ?></strong>
                </p>
                <?php if ($this->agregar_valor == 1) { ?>
                    ...
                    <p style="margin: 0; font-size: 16px;">
                        <span style="color: #0d3a58;"> Observaciones: </span> <strong> <?php echo $this->proyectos_caprueba; ?></strong>
                    </p>
                <?php } else { ?>
                    <p style="margin: 0; font-size: 16px;">
                        <span style="color: #0d3a58;"> Observaciones: </span> <strong> <?php echo $this->proyectos_cadmin; ?></strong>
                    </p>
                <?php } ?>
            </div>
        </div>
