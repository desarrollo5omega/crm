...
class Page_viewController extends Page_mainController
{
	...
	public function requerimientoAction() {
        ...
        $proyectosModel =  new Page_Model_DbTable_Proyectos();
        $proyecto = $this->_getSanitizedParam('proyecto');
		$reque = $this->_getSanitizedParam('r');
		...
		$requerimientosModel = new Administracion_Model_DbTable_Requerimientos();
		$this->_view->req = $requerimientosModel->getById($reque);
    ...
    public function buscarProyectosAction()
	{
		...
		if ($_SESSION["kt_login_level"] == 5) {
			...
			foreach($proyectos as $valor){
				$info = $proyectosModel->getList(" id = '$valor->proyectosing_proyecto' AND cliente_id = '".$cliente."' AND ( estado = '1' OR estado = '3' OR estado = '4' ) ","");
			...
			$proyectosModel =  new Page_Model_DbTable_Proyectos();
			$proyectos = $proyectosModel->getList("cliente_id = '".$cliente."' AND ( estado = '1' OR estado = '3' OR estado = '4' )  "," fecha_c DESC");
