...
<div class="container-fluid">
	<form action="<?php echo $this->route."?detalle=".$_GET['detalle']; ?>" method="post">
        <div class="content-dashboard">
            <div class="row">
				<div class="col-lg-3 ocultar_detalle">
		            <label>Fecha c</label>
                ...
                <div class="col-lg-3">
                    <label>&nbsp;</label>
                    <a class="btn btn-block btn-azul-claro " href="<?php echo $this->route; ?>?cleanfilter=1&detalle=<?php echo $_GET['detalle']; ?>" > <i class="fas fa-eraser"></i> Limpiar Filtro</a>
                </div>
            </div>
        </div>
    </form>
					...
					<tr>
						<td colspan="6" class="text-end">
							<div class="ocultar_detalle">
								...
								<span data-bs-toggle="tooltip" data-placement="top" title="Detalle"><a class="btn btn-amarillo btn-sm" data-bs-toggle="modal" data-bs-target="#modal_detalle<?= $id ?>"  ><i class="fas fa-info-circle"></i></a></span>

								<a class="btn btn-azul btn-sm" href="/page/seguimientoproyecto/?proyecto=<?= $id ?>" data-bs-toggle="tooltip" data-placement="top" title="Seguimientos"><i class="far fa-comment-dots"></i></a>
