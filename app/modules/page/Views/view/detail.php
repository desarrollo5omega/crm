            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 my-3 d-flex justify-content-between align-items-center">
                        ...
                        ?>
                            <div class="alert alert-info" role="alert" style="margin: 0px; padding-top: 5px; padding-bottom: 5px;">
                                <strong>Info:</strong> Proyecto asignado en el plan de trabajo.
                            </div>
                        <?php } } ?>

                        <div class="d-flex align-items-center"> <!-- Ajuste aquí para centrar verticalmente -->
                            <span data-bs-toggle="tooltip" data-placement="top" title="Finalizar relación" class="ms-3">
                                <a class="custom-btn-home" href="/page/view/finalizar?id=<?= $this->info->id ?>&cliente=<?= $_GET["cliente"] ?>&proyecto=<?= $_GET["proyecto"] ?>" id="terminar_proyecto">
                                    <span class="add-button-home-2 lf-part-2">FINALIZAR RELACIÓN</span>
                                    <span class="rg-part"><i class="fas fa-clock"></i></span>
                                </a>
                            </span>
                            <span data-bs-toggle="tooltip" data-placement="top" title="Edición general" class="ms-3">
                                            ...
                                            <div class="row px-3">
                                                ...
                                                <div class="col-12">
                                                    <div class="content-table m-0">
                                                        ...
                                                        <input type="hidden" name="r" value="detail">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center h-100">
                                                            ...
                                                            <div class="me-2">
                                                                <button id="add-row-adjuntos" class="btn btn-primary btn-sm" type="button">
                                                                    <i class="fas fa-plus"></i> Agregar campo para adjunto
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-4">
                                                            <div class="card">
                                                                ...
                                                                <div class="card-footer">
                                                                    <button class="btn btn-danger btn-sm btn-delete-adjuntos"><i class="fas fa-minus"></i> Quitar campo</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-12 mt-2 d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            <span data-bs-toggle="tooltip" data-placement="top" title="Recuperar Columnas" class=" me-3"  id="botonRecuperar" style="display:none;">
                            ...
                            <span data-bs-toggle="tooltip" data-placement="top" title="Agregar secciones" class="me-3">
...
<script>
    ...
    function redistribuirTarjetas() {
        ...
        const cards = container.querySelectorAll('.col-4, .col-6, .col-12');
        const numCards = cards.length;

        cards.forEach(card => {
            card.classList.remove('col-4', 'col-6', 'col-12');
        });

        if (numCards === 1) {
            cards[0].classList.add('col-12');
        } else if (numCards === 2) {
            cards.forEach(card => {
    ...
    $(document).ready(function() {
        $('#terminar_proyecto').on('click', function(e) {
            ...
            var confirmar = confirm("¿Estás seguro de que deseas terminar la relación con este proyecto ?");
