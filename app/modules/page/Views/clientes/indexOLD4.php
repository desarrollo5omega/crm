	...
	<form action="<?php echo $this->route; ?>" method="post">
        <div class="content-dashboard">
            <div class="row">
                ...
                <div class="col-lg">
                    <label>&nbsp;</label>
                    <a class="btn btn-block btn-azul-claro " href="<?php echo $this->route; ?>?cleanfilter=1" > <i class="fas fa-eraser"></i> Limpiar</a>
                </div>
            </div>
        </div>
    </form>
					...
					<tr>
						<td colspan="11" class="text-end">
							<div>
								...
								<a class="btn btn-amarillo btn-sm d-none" href="/page/contactos/?cliente=<?= $id ?>" data-bs-toggle="tooltip" data-placement="top" title="Contactos"><i class="fas fa-users"></i></a>

								<a style="color: #FFFFFF"  onclick="document.getElementById('iframe_proyectos').src='/page/proyectos/?cliente=<?= $id ?>&detalle=1&cleanfilter=1&page=1'; $('#header_proyecto').html('Cliente: <?= $content->nombre;?>'); " class="btn btn-verde btn-sm " data-bs-toggle="modal" data-bs-target="#modal_proyectos"><i class="fas fa-project-diagram" data-bs-toggle="tooltip" data-placement="top" title="Proyectos"></i></a>
								
								<a style="color: #FFFFFF"  onclick="document.getElementById('iframe_seguimientos').src='/page/contactos/?cliente=<?= $id ?>&detalle=1&cleanfilter=1&page=1'; $('#header_seguimiento').html('Cliente: <?= $content->nombre;?>'); " class="btn btn-amarillo btn-sm " data-bs-toggle="modal" data-bs-target="#modal_seguimientos"><i class="fas fa-users" data-bs-toggle="tooltip" data-placement="top" title="Contactos"></i></a>
...
<div class="modal fade text-start" id="modal_seguimientos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  	<div class="modal-dialog modal-lg" role="document">
    	<div class="modal-content ">
      		<div class="modal-header">
      			<h5 class="modal-title" id="header_seguimiento"></h5>
        		<button type="button" class="close btn-close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade text-start" id="modal_proyectos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  	<div class="modal-dialog modal-lg" role="document">
    	<div class="modal-content ">
      		<div class="modal-header">
      			<h5 class="modal-title" id="header_proyecto"></h5>
        		<button type="button" class="close btn-close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
