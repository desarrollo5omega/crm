			...
			<div class="col-12">
				<div class="row">
									...
									<tbody>					
										...
										<tr class="div_clientes" id="div_cliente<?php echo $key; ?>" <?php if($key>5){ echo 'style="display:none";'; } ?>>
											...
											<td>
												...
												<span data-bs-toggle="tooltip" data-placement="top" title="Detalle"><a class="btn btn-azul-claro1 btn-sm" data-bs-toggle="modal" data-bs-target="#modal_detalle<?= $id ?>" onclick="document.getElementById('iframe_proyecto<?php echo $id; ?>').src='/page/proyectos/?cliente=<?php echo $id; ?>&detalle=1&cleanfilter=1&page=1'; document.getElementById('iframe_contacto<?php echo $id; ?>').src='/page/contactos/?cliente=<?php echo $id; ?>&detalle=1&cleanfilter=1&page=1';" ><img src="/corte/info_verde.png" height="22" /></a></span>		
											</td>
										</tr>
										<?php } ?>
									</tbody>
	                ...
	                <label class="input-group">
                      ...
                      <?php endforeach ?>
						...
						<div class="col-lg-12 mt-4 content-dashboard">
							...
							<div class="caja_azul"><b class="titulo_dashboard">Próximas programaciones</b></div>
							<div class="content-table">
								<table width="100%" border="0" class="table table-striped">
									<thead>
										<tr>
					...
					<div class="col-4 mt-4">
						<div class="caja_azul"><b class="titulo_dashboard">Proyectos aprobados</b></div>
