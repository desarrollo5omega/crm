				  	...
				  	<div class="modal-dialog modal-lg" role="document">
				    	<div class="modal-content">
					      	...
					      	<div class="modal-body">
								...
								<div class="row">
									<iframe width="100%" height="600" frameborder="0" src="/page/contactos/?cliente=<?php echo $id; ?>&detalle=1"></iframe>
								</div>								
									...
									<div class="row">
										...
										<div class="col-lg-6 form-group">
											...
											<?php if($content->documento1!=""){ ?>
												<br><a href="/images/<?php echo $content->documento1; ?>" target="_blank" class="btn btn-primary btn-sm"><i class="fas fa-file-download"></i></a>
											<?php } ?>
										...
										<div class="col-lg-6 form-group">
											...
											<?php if($content->documento2!=""){ ?>
												<br><a href="/images/<?php echo $content->documento2; ?>" target="_blank" class="btn btn-primary btn-sm"><i class="fas fa-file-download"></i></a>
											<?php } ?>		
										...
										<div class="col-lg-6 form-group">
											...
											<?php if($content->documento3!=""){ ?>
												<br><a href="/images/<?php echo $content->documento3; ?>" target="_blank" class="btn btn-primary btn-sm"><i class="fas fa-file-download"></i></a>
											<?php } ?>
