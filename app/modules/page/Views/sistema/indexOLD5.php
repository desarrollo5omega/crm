					...
					<div class="col-8">
						...
						<div class="col-lg-12 mt-4 content-dashboard">
							...
							<div align="right" style="margin-top: -30px;">
								...
								<a style="cursor: pointer;" onclick="atras();"><i class="fas fa-chevron-circle-left"></i></a> <a style="cursor: pointer;" onclick="adelante();"><i class="fas fa-chevron-circle-right"></i></a>
