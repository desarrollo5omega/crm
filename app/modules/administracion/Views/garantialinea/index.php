...
<div class="container-fluid">
	<form action="<?php echo $this->route; ?>" method="post">
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            <label>gl_linea_id</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-rosado " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="gl_linea_id" value="<?php echo $this->getObjectVariable($this->filters, 'gl_linea_id') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>gl_garantia_id</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-azul " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="gl_garantia_id" value="<?php echo $this->getObjectVariable($this->filters, 'gl_garantia_id') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-start">
			<thead>
				<tr>
					<td>gl_linea_id</td>
					<td>gl_garantia_id</td>
					<td width="100"></td>
				</tr>
			</thead>
			<tbody>
				<?php foreach($this->lists as $content){ ?>
				<?php $id =  $content->gl_id; ?>
					<tr>
						<td><?=$content->gl_linea_id;?></td>
						<td><?=$content->gl_garantia_id;?></td>
						<td class="text-end">
							<div>
