        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="concepto" value="<?php echo $this->getObjectVariable($this->filters, 'concepto') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>v1</label>
		            ...
		            <input type="text" class="form-control" name="v1" value="<?php echo $this->getObjectVariable($this->filters, 'v1') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>v2</label>
		            ...
		            <input type="text" class="form-control" name="v2" value="<?php echo $this->getObjectVariable($this->filters, 'v2') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>v3</label>
		            ...
		            <input type="text" class="form-control" name="v3" value="<?php echo $this->getObjectVariable($this->filters, 'v3') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
