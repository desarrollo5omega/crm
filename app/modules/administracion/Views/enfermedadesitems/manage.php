			...
			<div class="row">
				<div class="col-12 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->enfermedad; ?>" name="enfermedad" id="enfermedad" class="form-control"   >
					</label>
				...
				<div class="col-12 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->formulario; ?>" name="formulario" id="formulario" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
			</div>
