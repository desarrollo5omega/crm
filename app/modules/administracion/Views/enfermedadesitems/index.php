        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="enfermedad" value="<?php echo $this->getObjectVariable($this->filters, 'enfermedad') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="formulario" value="<?php echo $this->getObjectVariable($this->filters, 'formulario') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-start">
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						<td><?=$content->enfermedad;?></td>
						<td><?=$content->formulario;?></td>
						<td class="text-end">
							<div>
