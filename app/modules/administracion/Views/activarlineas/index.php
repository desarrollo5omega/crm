        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="activar_documento" value="<?php echo $this->getObjectVariable($this->filters, 'activar_documento') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
					<label>Linea</label>
	                <label class="input-group">
	                    ...
	                    <select class="form-select" name="activar_linea">
	                        <option value="">Todas</option>
	                        <?php foreach ($this->list_activar_linea as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'activar_linea') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-start">
			...
			<tbody>
				...
				<?php $id =  $content->activar_id; ?>
					<tr>
						<td><?=$content->activar_documento;?></td>
						<td><?= $this->list_activar_linea[$content->activar_linea];?>
						<td class="text-end">
							<div>
