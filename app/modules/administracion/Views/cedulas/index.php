        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="aportes" value="<?php echo $this->getObjectVariable($this->filters, 'aportes') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>codigo_nomina</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-cafe " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="codigo_nomina" value="<?php echo $this->getObjectVariable($this->filters, 'codigo_nomina') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>nombre_nomina</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-morado " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="nombre_nomina" value="<?php echo $this->getObjectVariable($this->filters, 'nombre_nomina') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						...
						<td><?=$content->cupo;?></td>
						<td><?=$content->aportes;?></td>
						<td><?=$content->codigo_nomina;?></td>
						<td><?=$content->nombre_nomina;?></td>
						<td class="text-end">
							<div>
