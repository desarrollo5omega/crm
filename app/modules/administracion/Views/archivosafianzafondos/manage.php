			...
			<div class="row">
				<div class="col-12 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->archivo; ?>" name="archivo" id="archivo" class="form-control"  required >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<input type="hidden" name="solicitud"  value="<?php echo $this->content->solicitud ?>">
				<div class="col-12 form-group">
