			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						...
						<td><?=$content->tasa_real;?></td>
						<td><?=$content->efectivo_anual;?></td>
						<td><?=$content->min_meses;?></td>
						<td><?=$content->max_meses;?></td>
						...
						<td class="text-end">
							<div>
								...
								<a class="btn btn-warning btn-sm" href="/administracion/rangos/?linea=<?= $id ?>" data-bs-toggle="tooltip" data-placement="top" title="Rangos"><i class="fas fa-list-ol"></i></a>
