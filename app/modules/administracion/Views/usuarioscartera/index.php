        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="userc_cedula" value="<?php echo $this->getObjectVariable($this->filters, 'userc_cedula') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Nombre</label>
		            ...
		            <input type="text" class="form-control" name="userc_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'userc_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="userc_regional" value="<?php echo $this->getObjectVariable($this->filters, 'userc_regional') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-start">
			...
			<tbody>
				...
				<?php $id =  $content->userc_id; ?>
					<tr>
						<td><?=$content->userc_cedula;?></td>
						<td><?=$content->userc_nombre;?></td>
						<td><?=$content->userc_regional;?></td>
						<td class="text-end">
							<div>
