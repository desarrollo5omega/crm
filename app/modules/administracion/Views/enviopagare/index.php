        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="envio_solicitud" value="<?php echo $this->getObjectVariable($this->filters, 'envio_solicitud') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>fecha</label>
		            ...
		            <input type="text" class="form-control" name="envio_fecha" value="<?php echo $this->getObjectVariable($this->filters, 'envio_fecha') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>quien</label>
		            ...
		            <input type="text" class="form-control" name="envio_quien" value="<?php echo $this->getObjectVariable($this->filters, 'envio_quien') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-start">
			...
			<tbody>
				...
				<?php $id =  $content->envio_id; ?>
					<tr>
						<td><?=$content->envio_solicitud;?></td>
						<td><?=$content->envio_fecha;?></td>
						<td><?=$content->envio_quien;?></td>
						<td class="text-end">
							<div>
