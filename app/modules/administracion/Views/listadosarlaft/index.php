...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-lg-12 text-end">
			<a href="/administracion/listadosarlaft/exportar/?excel=1" target="_blank"><button type="button" class="btn btn-primary">exportar</button></a>
		</div>
	</div>
					...
					<tr>
						...
						<td class="text-end">
							...
							<div>
								...
								<a class="btn btn-azul btn-sm" href="<?php echo $this->route;?>/detalle?documento=<?= $content->cedula; ?>" data-bs-toggle="tooltip" data-placement="top" title="Detalle"><i class="fas fa-eye"></i></a>
