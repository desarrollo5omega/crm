					...
					<tr>
						...
						<td class="text-end">
							<div>
								...
								<span data-bs-toggle="tooltip" data-placement="top" title="Eliminar" class="d-none"><a class="btn btn-rojo btn-sm" data-bs-toggle="modal" data-bs-target="#modal<?= $id ?>"  ><i class="fas fa-trash-alt" ></i></a></span>
							</div>
							<!-- Modal -->
