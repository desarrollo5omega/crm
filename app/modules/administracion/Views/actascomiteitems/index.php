...
<div class="container-fluid">
	<form action="<?php echo $this->route; ?>" method="post">
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            <label>aci_acta_id</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-rosado " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="aci_acta_id" value="<?php echo $this->getObjectVariable($this->filters, 'aci_acta_id') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>aci_solicitud_id</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-rojo-claro " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="aci_solicitud_id" value="<?php echo $this->getObjectVariable($this->filters, 'aci_solicitud_id') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>aci_fecha</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-verde " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="aci_fecha" value="<?php echo $this->getObjectVariable($this->filters, 'aci_fecha') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-start">
			...
			<tbody>
				...
				<?php $id =  $content->aci_id; ?>
					<tr>
						<td><?=$content->aci_acta_id;?></td>
						<td><?=$content->aci_solicitud_id;?></td>
						<td><?=$content->aci_fecha;?></td>
						<td class="text-end">
							<div>
