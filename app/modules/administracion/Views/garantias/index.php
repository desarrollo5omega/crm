...
<div class="container-fluid">
        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="garantia_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'garantia_nombre') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-start">
			<thead>
				<tr>
					<td>garantia_nombre</td>
					<td width="100"></td>
				</tr>
			</thead>
			<tbody>
				<?php foreach($this->lists as $content){ ?>
				<?php $id =  $content->garantia_id; ?>
					<tr>
						<td><?=$content->garantia_nombre;?></td>
						<td class="text-end">
							<div>
