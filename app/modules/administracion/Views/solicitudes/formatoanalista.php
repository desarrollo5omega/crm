	...
	<div class="row">
		<?php if($_GET['excel']==""){ ?>
			<div class="col-12 text-end">
				<br><br>
				<a href="/administracion/solicitudes/formatoanalista/?id=<?php echo $this->id; ?>&excel=1"><button type="button" class="btn btn-primary d-none">Exportar</button></a>
				<a href="/administracion/solicitudes/formatoanalista/?id=<?php echo $this->id; ?>&pdf=1"><button type="button" class="btn btn-primary">Exportar PDF</button></a>
			</div>
		<?php } ?>
		...
		<table width="100%" cellpadding="3" cellspacing="0" border="0">
			...
			<tr>
				<td colspan="7">
					<?php
						$fecha = $this->solicitud->fecha_aprobado;
