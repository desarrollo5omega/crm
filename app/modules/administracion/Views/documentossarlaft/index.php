	...
	<form action="<?php echo $this->route; ?>" method="post">
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            <label>certificado_ingresos</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-cafe " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="certificado_ingresos" value="<?php echo $this->getObjectVariable($this->filters, 'certificado_ingresos') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="desprendible" value="<?php echo $this->getObjectVariable($this->filters, 'desprendible') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>anio</label>
		            ...
		            <input type="text" class="form-control" name="anio" value="<?php echo $this->getObjectVariable($this->filters, 'anio') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						...
						<td><?=$content->certificado_ingresos;?></td>
						<td><?=$content->declaracion_renta;?></td>
						<td><?=$content->desprendible;?></td>
						<td><?=$content->anio;?></td>
						<td class="text-end">
							<div>
