        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="fecha_d" value="<?php echo $this->getObjectVariable($this->filters, 'fecha_d') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>fecha_m</label>
		            ...
		            <input type="text" class="form-control" name="fecha_m" value="<?php echo $this->getObjectVariable($this->filters, 'fecha_m') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>fecha_a</label>
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="edad" value="<?php echo $this->getObjectVariable($this->filters, 'edad') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>nivel_escolar</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-rojo-claro " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="nivel_escolar" value="<?php echo $this->getObjectVariable($this->filters, 'nivel_escolar') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>i</label>
		            ...
		            <input type="text" class="form-control" name="i" value="<?php echo $this->getObjectVariable($this->filters, 'i') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						...
						<td><?=$content->fecha_d;?></td>
						<td><?=$content->fecha_m;?></td>
						<td><?=$content->fecha_a;?></td>
						<td><?=$content->edad;?></td>
						<td><?=$content->nivel_escolar;?></td>
						<td><?=$content->i;?></td>
						<td class="text-end">
							<div>
