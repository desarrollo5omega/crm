        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="log_date" value="<?php echo $this->getObjectVariable($this->filters, 'log_date') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="log_solicitud" value="<?php echo $this->getObjectVariable($this->filters, 'log_solicitud') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Log</label>
		...
		<table class=" table table-striped  table-hover table-administrator text-start">
			...
			<tbody>
				...
				<?php $id =  $content->log_id; ?>
					<tr>
						<td><?=$content->log_date;?></td>
						<td><?=$content->log_solicitud;?></td>
