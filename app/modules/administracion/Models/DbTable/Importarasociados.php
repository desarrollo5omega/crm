<?php 
/**
* clase que genera la insercion y edicion  de importar asociados en la base de datos
*/
class Administracion_Model_DbTable_Importarasociados extends Db_Table
{
	...
	/**
	 * insert recibe la informacion de un importar asociados y la inserta en la base de datos
