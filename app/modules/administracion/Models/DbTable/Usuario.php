...
class Administracion_Model_DbTable_Usuario extends Db_Table
{
	...
	public function update($data,$id){
		...
		$query = " UPDATE user SET user_state = '$user_state', user_names = '$user_names', user_email = '$user_email', user_level = '$user_level', user_user = '$user_user' $changepasword  WHERE user_id = '".$id."' ";
		$res = $this->_conn->query($query);
	}
}