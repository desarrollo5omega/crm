<?php 
/**
* clase que genera la insercion y edicion  de prueba en la base de datos
*/
class Administracion_Model_DbTable_Prueba extends Db_Table
{
	/**
	...
	/**
	 * insert recibe la informacion de un prueba y la inserta en la base de datos
