...
class Administracion_loginuserController extends Controllers_Abstract
{
  ...
  public function indexAction()
  {
    ...
    if ($isError == false) {
      if (Session::getInstance()->get('kt_login_level') == "14" || Session::getInstance()->get('kt_login_level') == "15" || Session::getInstance()->get('kt_login_level') == "16") {
      ...
      if (($_SESSION['kt_login_level'] == "4" or $_SESSION['kt_login_level'] == "8" or $_SESSION['kt_login_level'] == "9") & ($this->_getSanitizedParam("url") != "")) {
        ...
        if ($_SESSION['kt_login_level'] == "1" or $_SESSION['kt_login_level'] == "4" or $_SESSION['kt_login_level'] == "9" or $_SESSION['kt_login_level'] == "13") {
          header("Location: /administracion/panel");
  ...
  public function logoutAction()
  {
    ...
    //Session::getInstance()->set("estado","");
    header('Location: /administracion/');
  }
}
